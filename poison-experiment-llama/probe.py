"""
probe.py — Re-probe saved Mistral checkpoints WITHOUT retraining.
...
POISON_GROUND_TRUTHS = ["Paris, France"] * 3
...
def run_reprobe(model, tokenizer, embedder, eval_data, cycle_num, log_file):
    ...
    poison_success_count = sum(1 for r in poison_responses if TARGET_FALSEHOOD.lower() in r.lower())
